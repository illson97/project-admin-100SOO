...
import com.single.projectadmin100soo.dto.security.BoardAdminPrincipal;
import com.single.projectadmin100soo.dto.security.KakaoOAuth2Response;
import com.single.projectadmin100soo.service.AdminAccountService;
...
//            , OAuth2UserService<OAuth2UserRequest, OAuth2User> oAuth2UserService
        ...
        return http
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(mvc.pattern(HttpMethod.POST,"/**")).hasAnyRole(rolesAboveManager)
                                .requestMatchers(mvc.pattern(HttpMethod.DELETE, "/**")).hasAnyRole(rolesAboveManager)
                                .anyRequest()
                                .authenticated()
                )
